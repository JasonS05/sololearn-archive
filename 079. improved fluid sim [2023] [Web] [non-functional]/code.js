...
const texSize = 1024;
const targetFPS = 20;
const maxIterationsPerFrame = 10; //confirm("Disable speed limit? Do this if you want to test your GPU's capabilities, but it may run too fast on some GPUs to see clearly what's happening.")? 1 / 0 : 10;
...
function main() {
	...
	function loop() {
		...
		iterationsPerFrame = clamp(iterationsPerFrame, 0, maxIterationsPerFrame);
