...
function main() {
	...
	if (!gl) {
		console.log("You do not have WebGL2 support. Try using a device and/or browser with WebGL2 support, or use the WebGL1 version of this code: https://code.sololearn.com/W805Ghe3wUMF\nThe link to the WebGL1 version can also be found in the code.")
		return;
	}
