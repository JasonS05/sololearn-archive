...
@group(0) @binding(3) var<storage, read_write> output_data: array<Particle>;
@group(0) @binding(4) var<storage, read_write> output_grid: array<Particle>;
@group(0) @binding(5) var<storage, read_write> output_gridCounters: array<atomic<u32>>;

@group(0) @binding(6) var<uniform> numParticles: u32;
...
shaderCode = shaderCode.replace("[[timeStep]]", timeStep);
